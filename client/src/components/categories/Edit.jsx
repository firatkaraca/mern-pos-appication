...
const Edit = ({ isEditModalOpen, setIsEditModalOpen, categories, setCategories }) => {
            ...
            render: (_, record) => {
                return (
                    <div>
                        ...
                        <Button type="link" className="text-gray-900" htmlType="submit">Kaydet</Button>
    ...
    return (
        <Modal open={isEditModalOpen} title="Kategori işlemleri" footer={false} onCancel={() => setIsEditModalOpen(false)}>
